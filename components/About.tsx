        ...
        <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, delay: 0.15 }}
          ...
          <div className="relative aspect-[3/4] overflow-hidden">
            <Image
              ...
              alt="Le Charme dining room interior — exposed brick, warm wood, vintage decor"
              fill
          ...
          <div className="absolute -bottom-6 -right-6 w-40 h-40 border border-or/20 -z-10" />
          <p className="absolute bottom-3 right-3 font-mono text-[9px] tracking-[0.08em] text-creme/30">
