...
const BAR    = "https://www.diningandcooking.com/wp-content/uploads/2025/10/52adec765aff5836dea23fcd167c4a0a.jpeg";
const BOOTHS = "https://www.diningandcooking.com/wp-content/uploads/2025/10/d48a88a647f99342757cf67a459b2868.jpeg";
        ...
        <div className="grid md:grid-cols-12 gap-6 md:gap-8 items-start">
          ...
          <motion.div initial={{opacity:0,x:-24}} whileInView={{opacity:1,x:0}} viewport={{once:true}} transition={{duration:0.8}}
            ...
            <div className="relative overflow-hidden" style={{aspectRatio:'3/4'}}>
              <Image
                src={BAR}
                alt="Le Charme interior — warm dining room with bar"
          ...
          <div className="md:col-span-7 flex flex-col justify-between gap-8">
            ...
            <motion.div initial={{opacity:0,x:24}} whileInView={{opacity:1,x:0}} viewport={{once:true}} transition={{duration:0.8,delay:0.2}}
              ...
              <Image
                src={BOOTHS}
                alt="Le Charme — Alberta Rainbow Trout dish"
                fill className="object-cover object-center"
                sizes="(max-width: 768px) 100vw, 36vw"
              />
              <div className="absolute inset-0 bg-gradient-to-b from-encre/10 to-encre/40" />
            </motion.div>
          </div>
        </div>
