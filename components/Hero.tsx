...
export default function Hero() {
  return (
    <section id="home" className="relative h-screen min-h-[600px] flex items-end pb-24 overflow-hidden">
      ...
      {/* Owner's interior photo — the real bar */}
      <div className="absolute inset-0">
        <Image
          ...
          sizes="100vw"
        />
        {/* Layered overlays for warmth + legibility */}
        <div className="absolute inset-0 bg-gradient-to-t from-encre via-encre/50 to-encre/20" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_50%_80%,rgba(204,63,53,0.18)_0%,transparent_70%)]" />
      </div>

      {/* Content — anchored to bottom left for editorial feel */}
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-10">
        ...
        <motion.h1 initial={{opacity:0,y:30}} animate={{opacity:1,y:0}} transition={{duration:0.9,delay:0.1}}
          ...
          style={{textShadow:'0 8px 60px rgba(0,0,0,0.4)'}}>
      ...
      <div className="absolute bottom-8 right-8 flex flex-col items-center gap-2">
        <span className="font-mono text-[9px] tracking-[0.25em] uppercase text-white/30" style={{writingMode:'vertical-lr'}}>Scroll</span>
